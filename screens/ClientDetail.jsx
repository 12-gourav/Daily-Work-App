...
import { deleteClient, updateClient,loadUser } from '../Redux/action';
...
const taskUpdate = async () =>{
  ...
  try {
    await dispatch(updateClient(Route.params.item._id));
...
const taskDelete = async ()=>{
  try {
    await  dispatch(deleteClient(Route.params.item._id));
