...
import { addWork, loadUser } from '../Redux/action';
...
const handleSubmit = async () => {
  ...
  await dispatch(addWork(title,description));
...
<ScrollView>
      ...
      <Text style={{textAlign:"center",fontSize:28,color:"#85AFEE",fontWeight:"700",textShadowColor:"rgba(133, 175, 238, 0.35)",textShadowOffset:{
              width:3,height:4
          },textShadowRadius:10}}>Create Work</Text>
  ...
  numberOfLines={5} placeholder='Enter Your Description' multiline ></TextInput>
      ...
      <View style={{alignItems:"center",marginTop:20}}>
          <TouchableOpacity onPress={()=> handleSubmit()}>
              <Image source={require("../assets/add2.png")} style={{resizeMode:"contain",width:320,height:250}}></Image>
          </TouchableOpacity>
      </View>
