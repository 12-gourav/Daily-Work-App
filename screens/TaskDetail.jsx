...
import { loadUser,updateTask,deleteTask } from '../Redux/action';
...
const taskUpdate = async () =>{
  ...
  try {
    await dispatch(updateTask(Route.params.item._id));
...
const taskDelete = async ()=>{
  try {
    await  dispatch(deleteTask(Route.params.item._id));
...
<TouchableOpacity onPress={()=>taskUpdate()}>
  <Image source={require("../assets/updatebtn.png")} style={{resizeMode:"contain"
  ,width:"100%",height:60,marginTop:20}}/></TouchableOpacity>
