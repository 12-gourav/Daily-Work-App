    ...
    <View style={{flex:1,paddingTop:Platform.OS === "android" ? StatusBar.currentHeight : 0}}>
        ...
        <View>
            <Text style={{textAlign:"center",fontSize:28,color:"#85AFEE",fontWeight:"700",textShadowColor:"rgba(133, 175, 238, 0.35)",textShadowOffset:{
                width:3,height:4
            },textShadowRadius:8}}>Your Works</Text>
        </View>
        {
            user.work[0] == null ?
          <Loader1/>
           :
           <View style={{width:"100%",paddingLeft:20,paddingRight:20,marginTop:30,flex:1,paddingBottom:10}}>
           <ScrollView  showsVerticalScrollIndicator={false}>
           {
            user.work.map((item)=>(
              <TouchableOpacity key={item._id} onPress={()=> Navigation.navigate("workdetail",{id:item._id,item:item})}>
